...
WEIGHT_INIT_CHOICES = [WEIGHT_INIT_XAVIER, WEIGHT_INIT_KAIMING, WEIGHT_INIT_ORTHOGONAL, WEIGHT_INIT_SWITCH,
                       WEIGHT_INIT_SWITCH_UNIFORM, WEIGHT_INIT_PALM, WEIGHT_INIT_DEPTH_SCALE, WEIGHT_INIT_T_FIXUP]
