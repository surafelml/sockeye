...
WEIGHT_INIT_XAVIER = 'xavier'
WEIGHT_INIT_XAVIER_ALL = 'xavier_all'
WEIGHT_INIT_KAIMING = 'kaiming'
WEIGHT_INIT_ORTHOGONAL = 'orthogonal'
WEIGHT_INIT_SWITCH = 'switch'
WEIGHT_INIT_SWITCH_UNIFORM = 'switch_uniform'
WEIGHT_INIT_PALM = 'palm'
WEIGHT_INIT_DEPTH_SCALE = 'depth_scale'
WEIGHT_INIT_T_FIXUP = 't_fixup'
WEIGHT_INIT_CHOICES = [WEIGHT_INIT_XAVIER, WEIGHT_INIT_XAVIER_ALL, WEIGHT_INIT_KAIMING, WEIGHT_INIT_ORTHOGONAL,
                       WEIGHT_INIT_SWITCH, WEIGHT_INIT_SWITCH_UNIFORM, WEIGHT_INIT_PALM, WEIGHT_INIT_DEPTH_SCALE,
                       WEIGHT_INIT_T_FIXUP]
